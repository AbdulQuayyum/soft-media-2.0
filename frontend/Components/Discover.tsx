...
import { Topics } from '../Utilities/Constants'

const Discover = () => {
  const router = useRouter()
  const { Topic } = router.query

  const activeTopicStyle = 'xl:border-2 hover:bg-primary xl:border-blue-700 px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer text-blue-700'
